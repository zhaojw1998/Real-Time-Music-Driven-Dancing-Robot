...
def main():
    ...
    detector = YOLOv3( model_def="C:\\users\\lenovo\\Desktop\\AI Project Porfolio\\3DMPPE_POSENET_RELEASE\\common\\detectors\\yolo\\config\\yolov3.cfg",
                       class_path="C:\\users\\lenovo\\Desktop\\AI Project Porfolio\\3DMPPE_POSENET_RELEASE\\common\\detectors\\yolo\\data\\coco.names",
                       weights_path="C:\\users\\lenovo\\Desktop\\AI Project Porfolio\\3DMPPE_POSENET_RELEASE\\common\\detectors\\yolo\\weights\\yolov3.weights",
                       classes=('person',),
                       max_batch_size=16,
    ...
    if args.demo == 'image':
        ...
        image_path = 'C:\\users\\lenovo\\Desktop\\AI Project Porfolio\\3DMPPE_POSENET_RELEASE\\image\\test3.jpg'
        ...
        video = cv2.VideoCapture('C:\\users\\lenovo\\Desktop\\AI Project Porfolio\\dance_videos\\test_sample.mp4')
