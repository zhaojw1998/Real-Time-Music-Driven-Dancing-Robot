...
with open('C:\\Users\\lenovo\\Desktop\\AI-Project-Portfolio\\Amendments\\scipts for graph construction\\01.typical_sequences.txt', 'rb') as f:
    typical_sequences = pickle.load(f)

with open('C:\\Users\\lenovo\\Desktop\\AI-Project-Portfolio\\Amendments\\scipts for graph construction\\simulation and check sequence validity\\unstable_sequences.txt', 'rb') as f:
