...
with open('./01.typical_sequences.txt', 'rb') as f:
    typical_sequences = pickle.load(f)

with open('./01.5.unstable_sequences.txt', 'rb') as f:
...
with open('./03.stable_typical_sequence_redundant_supress.txt', 'wb') as f:
