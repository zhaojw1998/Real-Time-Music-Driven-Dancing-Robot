...
repeat_sequence = {}
max_duration = 32
for duration in range(1, max_duration+1):   #detecting repeat sequences with different duration
...
with open('C:\\Users\\lenovo\\Desktop\\AI-Project-Portfolio\\Amendments\\scipts for graph construction\\02.repeat_sequences_redundant_supress.txt', 'wb') as f:
